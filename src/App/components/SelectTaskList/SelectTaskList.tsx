...
export default function SelectTaskList({ width }: SelectTaskListProps) {
	...
	const columns = [
		...
		new ListColumnData({ name: data.filters.servicesApproved.fieldName, code: data.filters.servicesApproved.fieldCode, fr: 1, isSortable: false, isLink: false, isRollable: true }),
	]
